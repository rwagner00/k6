...
k6 run woo-checkout.js --env BYPASS_CACHE=1  --vus="${VUS}" --duration="${DURATION}" --env SITE_URL=https://live-pasta-la-vista.pantheonsite.io/
...
k6 run woo-customer.js --env BYPASS_CACHE=1  --vus="${VUS}" --duration="${DURATION}" --env SITE_URL=https://live-pasta-la-vista.pantheonsite.io/
